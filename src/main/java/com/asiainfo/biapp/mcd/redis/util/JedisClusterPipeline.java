...
public class JedisClusterPipeline extends PipelineBase implements Closeable {
    ...
    /**
     * @Description: 刷新集群信息，当集群信息发生变更时调用
     *
     */
    ...
    /**
     * @Description: 同步读取所有数据. 与syncAndReturnAll()相比，sync()只是没有对数据做反序列化
     *
     */
    public void sync() {
        innerSync(null);
    ...
    /**
     * @Description: 同步读取所有数据并按命令顺序返回一个列表
     * 
    ...
    private void flushCachedData(Jedis jedis) {
        ...
        try {
        	...
        	LOGGER.error("error on flushCachedData!", ex);
        }
    }
